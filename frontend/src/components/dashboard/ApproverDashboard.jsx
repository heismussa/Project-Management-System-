...
export default function ApproverDashboard() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4" style={{ gridTemplateColumns: '1.4fr 1fr' }}>
      ...
      <DashboardSection icon={ClipboardCheck} title="Execution Sign-off Queue" noPadding className="mt-4">
        <DataTable
          hideSearch
          rowKey="project_id"
          ...
          columns={[
            {
              ...
              render: (value, record) => (
                <button type="button" className="font-medium text-[#650018] underline" onClick={() => open(record)}>
                  {value}
                </button>
              ),
            },
