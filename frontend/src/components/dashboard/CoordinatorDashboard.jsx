...
export default function CoordinatorDashboard() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4" style={{ gridTemplateColumns: '280px 1fr' }}>
        <TintedMetricCard
          icon={Inbox}
      ...
      <DashboardSection icon={Inbox} title="Awaiting Recommendation" noPadding className="mt-4">
        <DataTable
          hideSearch
          rowKey="project_id"
